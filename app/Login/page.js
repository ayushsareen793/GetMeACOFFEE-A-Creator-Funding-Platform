...
const Login = () => {
  ...
  return (
    <div className="bg-black min-h-screen text-white grid grid-cols-1 lg:grid-cols-2 overflow-hidden">

      {/*  geometric design*/}
      <div className="relative overflow-hidden bg-[#0d0d12]  flex-col justify-center px-6 sm:px-10 lg:px-16 py-14 lg:py-20 hidden lg:flex">
      ...
      {/* login form */}
      <div className="flex flex-col justify-center px-6 sm:px-10 lg:px-16 py-14 lg:py-20 relative">
        <div className="absolute top-8 right-8 w-16 h-16 border border-purple-600/20 rotate-45 pointer-events-none hidden sm:block" />
        <div className="absolute bottom-8 left-8 w-10 h-10 bg-purple-600/10 rotate-12 pointer-events-none hidden sm:block" />
        ...
        <h1 className="font-black leading-[0.92] tracking-[-0.04em] mb-3 text-[clamp(32px,5vw,60px)]">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.15em] text-purple-600/60 text-center">why creators choose us</span>
          <div className="flex-1 h-px bg-purple-600/20" />
        </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 shrink-0 bg-purple-600/15 border border-purple-600/40 flex items-center justify-center text-[11px] font-black text-purple-400">1</div>
            <p className="text-[13px] text-[#ccc] leading-[1.6]">Set up your profile in minutes.</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 shrink-0 bg-purple-600/15 border border-purple-600/40 flex items-center justify-center text-[11px] font-black text-purple-400">2</div>
             <p className="text-[13px] text-[#ccc] leading-[1.6]">Customize your profile to match your style and personality.</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 shrink-0 bg-purple-600/15 border border-purple-600/40 flex items-center justify-center text-[11px] font-black text-purple-400">3</div>
            <p className="text-[13px] text-[#ccc] leading-[1.6]">Get paid directly with no platform cuts on your tips.</p>
          </div>
        </div>

        <p className="text-[12px] text-[#444] mt-8 text-center">
          Join creators already getting supported every day.
        </p>
      </div>
