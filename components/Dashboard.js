...
//         setOldusername(data.username) // ye poorane session(jisme saara data h) ko save nhi krta , updated vale ko hi krta h 
...
const Dashboard = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setOldusername(data.username) // keeps this in sync so your next save this session doesn't compare against a stale value
        toast('Profile Updated', {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
