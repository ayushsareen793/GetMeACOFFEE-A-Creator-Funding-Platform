        ...
        <div className="px-6 sm:px-10 md:px-16 py-10 md:py-16 border-b-2 border-[#9333ea]/20">
          <div className="relative max-w-4xl mx-auto bg-black border-2 border-[#9333ea] p-8 sm:p-12 overflow-hidden [clip-path:polygon(0_0,calc(100%-20px)_0,100%_20px,100%_100%,0_100%)]">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 bg-[#9333ea]/10 border border-[#9333ea]/25 text-[#a855f7] text-[11px] font-black uppercase tracking-[0.18em] px-4 py-1.5 mb-6">
                <div className="w-1.5 h-1.5 rounded-full bg-[#9333ea]" />
                About This Creator
              </div>

              {currentuser?.bio ? (
                <p className="text-[#e8e8f0] text-[16px] sm:text-[19px] leading-relaxed whitespace-pre-line font-medium tracking-[-0.01em] max-w-2xl">
                  {currentuser.bio}
                </p>
              ) : (
                <p className="text-[#444] text-[14px] italic">
                  This creator hasn't added a bio yet.
                </p>
              )}
